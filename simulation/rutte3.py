"""Plan Rutte 1 is to not let the virus spread -> lockdown."""
...
params = {
    ...
    "R_control": 0.5,  # the basic reproduction rate after government measures in the period 12 march - 8 april 2020
    ...
    "test_rt" : 0.01,  # percentage that gets tested.
    "dur": 365
}
...
df.to_excel('../data/sim_rutte_3.xlsx')